...
call s:h("MatchParen",    {"bg": s:yellow, "fg": s:bg_dark, "gui": "bold", "cterm": "bold"})
...
hi User1 guifg=#F48FB1 guibg=#585273 ctermfg=204 ctermbg=236 " read only
hi User2 guifg=#c3e88d guibg=#585273 ctermfg=114 ctermbg=236 " modified
hi User3 guifg=#89ddff guibg=#585273 ctermfg=39 ctermbg=236 " filename
