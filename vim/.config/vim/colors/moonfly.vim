...
exec 'highlight TablineFill ctermbg=' . s:grey233.term . ' ctermfg=' . s:grey236.term . ' cterm=none guibg=' . s:grey233.hex . ' guifg=' . s:grey236.hex . ' gui=none'
...
if g:moonflyVertSplits
    exec 'highlight VertSplit ctermbg=' . s:grey236.term . ' ctermfg=' . s:grey249.term . ' cterm=none guibg=' . s:grey236.hex . ' guifg=' . s:grey249.hex . ' gui=none'
else
...
exec 'highlight Conceal ctermbg=' . s:black.term . ' ctermfg=' . s:white.term . ' guibg=' . s:black.hex . ' guifg=' . s:white.hex
...
hi User1 guifg=#ff5454 guibg=#303030 ctermfg=1   ctermbg=236
hi User2 guifg=#36c692 guibg=#303030 ctermfg=10  ctermbg=236
hi User3 guifg=#c6c6c6 guibg=#303030 ctermfg=251 ctermbg=236
hi User4 guifg=#080808 guibg=#808080 ctermfg=232 ctermbg=244
hi User5 guifg=#080808 guibg=#80a0ff ctermfg=232 ctermbg=4
