...
" read only, modified, filename, inactive
hi! link User1 GruvboxRedSign
hi! link User2 GruvboxGreenSign
hi! link User3 WildMenu
" hi User1 guifg=#d04863 guibg=#1a1a1a
" hi User2 guifg=#00baa8 guibg=#1a1a1a
" hi User3 guifg=#f5fef8 guibg=#504945
